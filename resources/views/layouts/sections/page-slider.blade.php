        ...
        <ul class="slides">
            <li class="ds s-overlay cover-image text-center">
                ...
                <video muted loop id="myVideo">
                    <source src="/images/Travel_Stock_Footage_Reel-HD_4K_Royalty-free.mp4" data-time="74"
                            type="video/mp4">
                </video>
                            ...
                            <div class="intro_layers_wrapper intro_text_bottom">
                                <div class="intro_layers">
                                    <div class="intro-layer">
                                                <span
                                                    class="small-text color-main3">we are hiking and outdoor club</span>
                                    </div>
                                    <div class="intro-layer mt-10">
                                        <h2><span class="semibold">Let's Enjoy</span> the Wonders of the Nature
                                            <span class="semibold">Together</span></h2>
                                    </div>
                                    <div class="divider-35 hidden-below-sm"></div>
                                    <div class="intro-layer hidden-below-sm">
                                        <p>Prosciutto tail venison burgdoggen hamburger frankfurter pork picanha
                                            landjaeger. Chicken ham hock picanha meatloaf kielbasa sausage
                                            bresaol</p>
                                    </div>
