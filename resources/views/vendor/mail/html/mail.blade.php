                ...
                <tr style="background: #f8a023">
                    <td class="header"
                        ...
                        <a href="https://markdownmail.com"
                           style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #f0f0f0; font-size: 19px; font-weight: bold; text-decoration: none; text-shadow: 0 1px 0 #ffffff;">
                            HolidayMontenegro
                        </a>
                    </td>
                </tr>
                            ...
                            <tr>
                                <td class="content-cell" align="center"
                                    ...
                                    <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; line-height: 1.5em; margin-top: 0; color: #aeaeae; font-size: 12px; text-align: center;">
                                        © 2019 HolidayMontenegro. All rights reserved.</p>
                                </td>
                            </tr>
                        </table>
                    </td>
